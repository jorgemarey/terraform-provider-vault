...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"vault_identity_secret_backend_entity":       identitySecretBackendEntityResource(),
			"vault_identity_secret_backend_entity_alias": identitySecretBackendEntityAliasResource(),
			"vault_identity_secret_backend_group":        identitySecretBackendGroupResource(),
			"vault_identity_secret_backend_group_alias":  identitySecretBackendGroupAliasResource(),
